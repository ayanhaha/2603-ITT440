...
* **TEST B (Parallel Only):** 16 Cores, 1 File – Completed in 16.06 seconds. This represents the fastest performance, showcasing the significant advantage of multi-core parallel processing for this cryptographic task.
* **TEST C (Concurrent Only):** 1 Core, 5 Files – Completed in 20.48 seconds. The results show that while concurrent writing was fast, it did not significantly reduce overall time, as the mathematical hashing was still performed sequentially on a single core.
